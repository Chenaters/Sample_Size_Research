...
####
# Sample size by simulations of predictive models
...
sigma.race = 1; #pair-wise covariance among individuals in the same ethnic group
beta.race = 1; #treat the "coefficient" of the mix-effect b_i be 1. 


## for quantitative outcome
beta.acup = 6; #Coeff of acupuncture
beta.mbsr = 6; #Coeff of mbsr
beta.sex = 1;
beta.age = -1;
beta.edu = 1;
beta.len = 1;
...
beta.biom.v =1; #2; #The value of the coeff of the biomarkers
...
beta.mdf.acup.v=1; #2; #The value of the coeff of accupunctur's modifiers
beta.mdf.acup = rep(beta.mdf.acup.v, mdfN.acup); #Vector of coeffs of accupunctur's modifiers 
gama.acup.v = 1; #2; #The value of the coeff of the modifier*acupucture interaction terms.
...
beta.mdf.mbsr.v=1; #2; #The value of the coeff of MBSR's modifiers
beta.mdf.mbsr = rep(beta.mdf.mbsr.v, mdfN.mbsr); #Vector of coeffs of accupunctur's modifiers 
gama.mbsr.v = 1; #2; #The value of the coeff of the modifier*MBSR interaction terms.
